...
from layers.patchTST.FlattenHead import FlattenHead
from layers.patchTST.TSTiEncoder import TSTiEncoder
...
class PatchTST_Backbone(nn.Module):
    def __init__(self,
        ...
        self.head = FlattenHead(device, self.head_nf, target_window)
